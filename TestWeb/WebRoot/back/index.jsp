                   ...
                   <img src="images/logo.png" height="100px" width="200px"></img>
                    ...
                    <ul class="layui-nav" lay-filter="">
                      ...
                      <%
                       ...
                       <c:if test="${empty sessionScope.user.uname}">
                       <a href="javascript:;">admin</a>
                       </c:if>
                        <dl class="layui-nav-child"> <!-- 二级菜单 -->
                          <dd><a href="#">个人信息</a></dd>
                          <dd><a href="#">切换帐号</a></dd>
                          <dd><a href="../exit.jsp">退出</a></dd>
                        </dl>
                      </li>
                      <!-- <li class="layui-nav-item">
                        <a href="" title="消息">
                      ...
                      <li class="layui-nav-item x-index"><a href="../index.jsp">前台首页</a></li>
                    </ul>
                </div>
            </div>
                      ...
                      <dl class="layui-nav-child">
                        ...
                        <li class="layui-nav-item">
                            ...
                            <dl class="layui-nav-child">
                                ...
                                <dd class="">
                                    <dd class="">
                                        <a href="javascript:;" _href="../NewsServlet?method=finAll">
