        ...
        <div class="x-body">
            ...
            <div class="layui-form-item">
                    ...
                    <div class="layui-input-inline">
                        ...
                        <input type="text" id="link" name="id" value="<%=request.getParameter("id") %>"  required lay-verify="required"
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-inline">
                        <select lay-verify="required" name="module" >
                                ...
                                <optgroup label="模块" >
                                	<%-- <option  selected><%=request.getParameter("module") %></option> --%>
                                	<%
                                		
                                		if(request.getParameter("module").equals("心健新闻")){
                                		%>
                                		...
                                		if(request.getParameter("module").equals("媒体报道")){
                                		%>
                                		...
                                		if(request.getParameter("module").equals("心理新闻")){
                                		%>
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-inline">
                        ...
                        autocomplete="off" class="layui-input" value="<%=request.getParameter("title") %>">
                    </div>
                </div>
                <div class="layui-form-item">
                    <label for="link" class="layui-form-label">
                    ...
                    <div class="layui-input-inline">
                        ...
                        autocomplete="off" class="layui-input" value="<%=request.getParameter("createTime") %>"> --%>
                        
                        <input placeholder="请输入日期"  value="<%=request.getParameter("createTime") %>" class="layui-input laydate-icon" onClick="laydate({istime: true, format: 'YYYY-MM-DD hh:mm:ss'})" >
                    </div>
                </div>
                ...
                <div class="layui-form-item">
                   ...
                   <%
                   	if(request.getParameter("img")!=""&&request.getParameter("img")!=null){
                   	%>
     	
                   	<img id="portrait" width="400" src="../upload/<%=request.getParameter("img")%>">
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-inline">
                        ...
                        placeholder="简介" class="layui-textarea fly-editor" style="height: 260px;"><%=request.getParameter("content") %></textarea>
                    </div>
                ...
                <div class="layui-form-item">
                    ...
                    <bottom  class="layui-btn" onclick="banner_del(this,'${news.id}')" 
